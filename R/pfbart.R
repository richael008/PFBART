...
)
{
   ...
   if(typeof(ChangePrior)  != "logical") stop("input ChangePrior must a logical variable")
   if(typeof(AllowSwap)  != "logical") stop("input AllowSwap must a logical variable")
   if(typeof(StopDeath)  != "logical") stop("input StopDeath must a logical variable")
   ...
   cres = .C('mbart',as.integer(nrow(x.train)), 
                  as.integer(ncol(x.train)), 
                  ...
                  as.integer(keepevery),  
                  as.integer(keeptrainfits),
                  as.integer(numcut), 
                  as.integer(usequants), 
                  as.integer(printcutoffs),
		              as.integer(verbose),
                  sdraw=double(nctot), 
                  ...
                  vcdraw=integer(ncol(x.train)*nctot),
		              as.integer(FixFirst),
                  as.integer(ChangePrior),
                  as.integer(AllowSwap),
                  as.integer(StopDeath))
